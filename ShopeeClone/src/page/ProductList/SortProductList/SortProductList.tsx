    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button className='h-8 bg-white px-4 text-center text-sm capitalize text-black hover:bg-white/80'>
            Mới nhất
          </button>
          <button className='h-8 bg-white px-4 text-center text-sm capitalize text-black hover:bg-white/80'>
            Bán chạy
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2'>
            <button className='curssor-not-allowed h-8 rounded-tl-sm rounded-bl-sm bg-white px-3 hover:bg-slate-100'>
              <svg
            ...
            <button className='cussor-not-allowed h-8 rounded-tr-sm rounded-br-sm bg-white px-3 hover:bg-slate-100'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
