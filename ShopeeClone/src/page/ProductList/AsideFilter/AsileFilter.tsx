...
export default function AsileFilter({ queryConfig, categories }: Props) {
  ...
  return (
    <div className='py-4'>
      ...
      >
        <svg viewBox='0 0 12 10' className='mr-4 h-4 w-3 fill-current'>
      ...
      <ul>
        {categories.map((categoriesItem, _) => {
      ...
      <div className='my-5'>
        ...
        <form className='mt-2'>
          ...
          <Button className='hover:bg-orange-80 flex w-full items-center justify-center bg-orange py-2 px-2 text-sm uppercase text-white'>
            Áp dụng
          </Button>
        </form>
      </div>
