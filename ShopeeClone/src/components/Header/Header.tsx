      ...
      <div className='container'>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-8 h-11 fill-white'>
              <g fillRule='evenodd'>
          ...
          <div className='col-span-1 justify-self-start'>
            <Popover
              ...
              renderPopover={
                <div className='shaddow-md relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm'>
                  <div className='p-2'>
                    <div className='capitalize text-gray-400'>Sản phẩm mới thêm</div>
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img src={avatar} alt='ảnh' className='h-11 w-11 object-cover' />
                        </div>
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>
                            [Life - 12% đơn 250k] Bộ nồi Inox 3 Đáy SUNHOUSE SH334 16, 20, 24 cm
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>d469.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                    ...
                    <div className='mt-6 flex items-center justify-between'>
                      ...
                      <button className='rounded-sm bg-orange px-5 py-2 capitalize text-white hover:bg-opacity-80'>
                        Xem Giỏ Hàng
                      </button>
                    </div>
                  </div>
